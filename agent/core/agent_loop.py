        ...
        if cloud_provider in {"hf-jobs", "gcp-vertex", "aws-sagemaker"}:
            if cloud_provider == "gcp-vertex":
                ...
                provider_instruction = (
                    ...
                    "show a concise preflight/request approval. Operation run "
                    "and cancel are approval-gated; do not use Hugging Face "
                    "Jobs or Google Cloud Vertex AI compute unless the "
                    "provider changes."
                )
            else:
                provider_instruction = (
